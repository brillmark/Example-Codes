(function() {
  ...
  var BMDropdown =
    ...
    '      <a href="https://www.airfarewatchdog.com/blog/" class="dropdown-toggle" data-toggle="dropdown" style="cursor: pointer;">' +
    '          <p>New Fare Sale!</p>' +
  ...
  function init() {
    ...
    // $("#navheader .navbar-nav.main > li.dropdown:nth-child(1) > a").attr("href", "https://www.airfarewatchdog.com/cheap-flights/from-user/");

    // Click events
    $('div').delegate(
      '#navheader .navbar-horizontal .navbar-nav.main > li.dropdown:nth-child(1)',
      'click',
      function() {
        location.href =
          'https://www.airfarewatchdog.com/cheap-flights/from-user/';
      }
    );

    $('div').delegate(
      '#navheader .navbar-horizontal .navbar-nav.main > li.dropdown:nth-child(2)',
      'click',
      function() {
        location.href = 'https://www.airfarewatchdog.com/blog/';
      }
    );
  }
