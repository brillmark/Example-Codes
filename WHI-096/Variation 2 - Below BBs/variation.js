(function() {
  ...
  --------------------*/
    ...
    // pure insertBefore
    bmHelper.insertAfter = function(targetElement, beforeElement) {
      if (targetElement) {
        targetElement.insertAdjacentHTML('afterend', beforeElement);
      }
    };
    // pure remove
    ...
    bmHelper.insertSection = function(sectionHtml) {
      ...
      if (sectionHtml) {
        //target element
        //target element (few pagea has different DOM structure, check the pathname and change the target element for this page)
        ...
        if (
          ...
          targetElement = document.querySelector(
            'main article div[data-which-id="article-section-general"]:nth-child(12)'
          );
        } else if (
          bmHelper.bmPath() ===
          '/reviews/steam-cleaners/article/top-five-best-steam-mops'
          ...
          targetElement = document.querySelector(
            'main article div[data-which-id="article-section-table"]:nth-child(11)'
          );
        } else if (
          bmHelper.bmPath() === '/reviews/hobs/article/top-five-best-hobs'
        ) {
          targetElement = document.querySelector(
            'main article div[data-which-id="article-section-table"]:nth-child(12)'
          );
        } else {
          targetElement = document.querySelector(
        ...
        // TBD
        //insert new section
        bmHelper.insertAfter(targetElement, sectionHtml);
      }
    };
